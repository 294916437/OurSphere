...
public class LikeUnlikeNoteConsumer {
    ...
    public DefaultMQPushConsumer mqPushConsumer() throws MQClientException {
        // Group 组
        String group = "oursphere_group1_" + MQConstants.TOPIC_LIKE_OR_UNLIKE;
        ...
        consumer.registerMessageListener((MessageListenerOrderly) (msgs, context) -> {
            ...
            try {
                ...
                if (CollUtil.isNotEmpty(finalOperations)) {
                    // DTO 转 DO
                    List<NoteLikePO> noteLikeDOS = finalOperations.stream()
                            .map(finalOperation -> NoteLikePO.builder()
                    ...
                    // 批量写入
                    noteLikePOMapper.batchInsertOrUpdate(noteLikeDOS);
                }
