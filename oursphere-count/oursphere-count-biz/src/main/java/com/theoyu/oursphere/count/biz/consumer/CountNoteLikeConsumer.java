...
import com.theoyu.oursphere.count.biz.enums.LikeUnlikeNoteTypeEnum;
import com.theoyu.oursphere.count.biz.model.dto.AggregationCountLikeUnlikeNoteMqDTO;
import com.theoyu.oursphere.count.biz.model.dto.CountLikeUnlikeNoteMqDTO;
...
@Component
@RocketMQMessageListener(consumerGroup = "oursphere_group_" + MQConstants.TOPIC_COUNT_NOTE_LIKE, // Group 组
...
public class CountNoteLikeConsumer implements RocketMQListener<String> {
    ...
    private void consumeMessage(List<String> bodys) {
        ...
        log.info("==> 【笔记点赞数】最终统计结果, {}", JsonUtils.toJsonString(countList));
        // 更新 Redis
