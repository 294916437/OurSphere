...
import com.theoyu.oursphere.count.biz.enums.CollectUnCollectNoteTypeEnum;
import com.theoyu.oursphere.count.biz.model.dto.AggregationCountCollectUnCollectNoteMqDTO;
import com.theoyu.oursphere.count.biz.model.dto.CountCollectUnCollectNoteMqDTO;
...
@Component
@RocketMQMessageListener(consumerGroup = "oursphere_group_" + MQConstants.TOPIC_COUNT_NOTE_COLLECT, // Group 组
