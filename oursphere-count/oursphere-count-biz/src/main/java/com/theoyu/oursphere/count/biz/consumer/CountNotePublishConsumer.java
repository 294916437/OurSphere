...
import com.theoyu.oursphere.count.biz.model.dto.NoteOperateMqDTO;
...
@Component
@RocketMQMessageListener(consumerGroup = "oursphere_group_" + MQConstants.TOPIC_NOTE_OPERATE, // Group 组
...
public class CountNotePublishConsumer implements RocketMQListener<Message> {
    ...
    private void handleTagMessage(String bodyJsonStr, long count) {
        ...
        // 更新 t_user_count 表
        userCountPOMapper.insertOrUpdateNoteTotalByUserId(count, creatorId);
    }
