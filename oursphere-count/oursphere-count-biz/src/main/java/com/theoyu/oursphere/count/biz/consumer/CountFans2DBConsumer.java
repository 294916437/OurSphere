...
@Component
@RocketMQMessageListener(consumerGroup = "oursphere_group_" + MQConstants.TOPIC_COUNT_FANS_2_DB, // Group 组
...
public class CountFans2DBConsumer implements RocketMQListener<String> {
    ...
    public void onMessage(String body) {
        ...
        if (CollUtil.isNotEmpty(countMap)) {
            ...
            countMap.forEach((k, v) -> userCountPOMapper.insertOrUpdateFansTotalByUserId(v, k));
        }
    }
}
