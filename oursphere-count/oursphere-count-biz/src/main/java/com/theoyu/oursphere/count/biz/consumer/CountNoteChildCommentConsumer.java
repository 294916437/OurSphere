...
import com.theoyu.oursphere.count.biz.enums.CommentLevelEnum;
import com.theoyu.oursphere.count.biz.model.dto.CountPublishCommentMqDTO;
import com.theoyu.oursphere.count.biz.model.mapper.CommentPOMapper;
...
@Component
@RocketMQMessageListener(consumerGroup = "oursphere_group_child_comment_total" + MQConstants.TOPIC_COUNT_NOTE_COMMENT, // Group 组
...
public class CountNoteChildCommentConsumer implements RocketMQListener<String> {
    ...
    private void consumeMessage(List<String> bodys) {
        ...
        for (Map.Entry<Long, List<CountPublishCommentMqDTO>> entry : groupMap.entrySet()) {
            ...
            commentPOMapper.updateChildCommentTotal(parentId, count);
        }
        // 获取所有一级评论的ID集合
