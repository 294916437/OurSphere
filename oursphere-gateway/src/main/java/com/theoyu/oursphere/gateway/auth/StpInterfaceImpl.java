package com.theoyu.oursphere.gateway.auth;
...
import com.theoyu.oursphere.gateway.constants.RedisKeyConstants;
...
public class StpInterfaceImpl implements StpInterface {
    ...
    public List<String> getPermissionList(Object loginId, String loginType) {
        ...
        try {
            ...
            log.error("解析用户 {} 角色信息失败", loginId, e);
            return Collections.emptyList(); // 或者抛出自定义业务异常
        } catch (Exception e) {
            log.error("获取用户 {} 角色列表时发生未知错误", loginId, e);
    ...
    public List<String> getRoleList(Object loginId, String loginType) {
        ...
        try {
            ...
            String useRolesValue = redisTemplate.opsForValue().get(userRolesKey);
            if (StringUtils.isBlank(useRolesValue)) {
                log.warn("用户 {} 的角色信息为空", loginId);
                return Collections.emptyList();
            }

            List<String> roles = objectMapper.readValue(useRolesValue, new TypeReference<>() {});
