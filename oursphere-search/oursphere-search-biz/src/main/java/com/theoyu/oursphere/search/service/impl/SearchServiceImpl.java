package com.theoyu.oursphere.search.service.impl;
...
import com.theoyu.oursphere.search.model.mapper.SelectMapper;
...
public class SearchServiceImpl implements SearchService {
    ...
    public PageResponse<SearchUserRspVO> searchUser(SearchUserReqVO searchUserReqVO) {
        ...
        // 构建 multi_match 查询，查询 nickname 和 user_id 字段
        sourceBuilder.query(QueryBuilders.multiMatchQuery(
                keyword, UserIndex.FIELD_USER_NICKNAME, UserIndex.FIELD_USER_APP_ID));
        ...
        try {
            ...
            for (SearchHit hit : hits) {
                ...
                String userAppId = (String) sourceAsMap.get(UserIndex.FIELD_USER_APP_ID);
