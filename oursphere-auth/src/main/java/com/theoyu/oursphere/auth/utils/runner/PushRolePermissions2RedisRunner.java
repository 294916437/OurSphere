package com.theoyu.oursphere.auth.utils.runner;
...
import com.theoyu.oursphere.auth.model.mapper.PermissionPOMapper;
import com.theoyu.oursphere.auth.model.mapper.RolePOMapper;
import com.theoyu.oursphere.auth.model.mapper.RolePermissionPOMapper;
    ...
    public void run(ApplicationArguments args) {
        ...
        try{
            ...
            if(CollUtil.isEmpty(roles)){
                ...
                // 角色ID-权限PO 对象的关系
                Map<Long, List<PermissionPO>> roleIdPermissionDOMap = Maps.newHashMap();
                ...
                roles.forEach(rolePO -> {
                    ...
                    if (CollUtil.isNotEmpty(permissionIds)) {
                        List<PermissionPO> perDOS = Lists.newArrayList();
